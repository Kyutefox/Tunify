-- =============================================================================
-- RESET + FRESH MIGRATION (normalized, row-wise schema)
-- =============================================================================
-- Run in Supabase SQL Editor. Drops all app tables then recreates them.
-- =============================================================================

drop table if exists public.user_playlist_tracks cascade;
drop table if exists public.user_folder_playlists cascade;
drop table if exists public.user_playlists cascade;
drop table if exists public.user_folders cascade;
drop table if exists public.user_liked_songs cascade;
drop table if exists public.user_playlist_shuffle cascade;
drop table if exists public.user_library_settings cascade;
drop table if exists public.user_playback_settings cascade;
drop table if exists public.user_recently_played cascade;
drop table if exists public.user_recent_searches cascade;
drop table if exists public.yt_personalization cascade;
drop table if exists public.user_downloaded_songs cascade;

-- -----------------------------------------------------------------------------
-- CREATE (normalized, row-wise)
-- -----------------------------------------------------------------------------
