...
class YtConstants {
  ...
  /// Numeric client ID for WEB_REMIX — sent as X-YouTube-Client-Name header.
  static const String innertubeClientId = '67';
  /// Fallback client version used when the live fetch hasn't completed yet.
  static const String innertubeClientVersionFallback = '1.20260213.01.00';
