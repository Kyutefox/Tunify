...
void main() {
  group('LibraryState', () {
    test('sortedPlaylists pins first then sorts by sortOrder', () {
      ...
      final state = LibraryState(playlists: [a, b], sortOrder: LibrarySortOrder.alphabetical);
    ...
    test('copyWith preserves unspecified fields', () {
      final state = LibraryState(searchQuery: 'hello', viewMode: LibraryViewMode.grid);
